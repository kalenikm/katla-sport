...
{
    /// <summary>
    /// Add Description, ManufactarerCode and Price with new configuration to CatalogueProduct model migration.
    /// </summary>
    public partial class AnddNewProductDescriptionManCodePrice : DbMigration
    {
